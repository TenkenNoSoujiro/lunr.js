...
(function (lunr) {
    ...
    (function (utils) {
        ...
        utils.binarySearchKey = function (array, key, keySelector, comparer, step = 1, bias = 0 /* TWOS_COMPLEMENT */) {
            ...
            switch (bias) {
                case 1 /* LEAST_UPPER_BOUND */: return l * step;
                case 2 /* GREATEST_LOWER_BOUND */: return (l - 1) * step;
...
(function (lunr) {
    ...
    (function (Query) {
        ...
        (function (wildcard) {
            ...
            wildcard[wildcard["LEADING"] = 1] = "LEADING";
            /** Append a wildcard to the term, unless a trailing wildcard already exists */
            wildcard[wildcard["TRAILING"] = 2] = "TRAILING";
        })(wildcard = Query.wildcard || (Query.wildcard = {}));
        /**
        ...
        (function (presence) {
             ...
             */
            presence[presence["OPTIONAL"] = 1] = "OPTIONAL";
            /**
             * Term's presence in a document is required, documents that do not contain
             * this term will not be returned.
             */
            presence[presence["REQUIRED"] = 2] = "REQUIRED";
            /**
             * Term's presence in a document is prohibited, documents that do contain
             * this term will not be returned.
             */
            presence[presence["PROHIBITED"] = 3] = "PROHIBITED";
        })(presence = Query.presence || (Query.presence = {}));
        /**
        ...
        (function (comparator) {
            ...
            comparator["GREATERTHAN_EQUALS"] = ">=";
            /** The field's value must be less than (`<`) the comparand. */
            comparator["LESSTHAN"] = "<";
            /** The field's value must be less than or equal to (`<=`) the comparand. */
            comparator["LESSTHAN_EQUALS"] = "<=";
        })(comparator = Query.comparator || (Query.comparator = {}));
    })(Query = lunr.Query || (lunr.Query = {}));
})(lunr || (lunr = {}));
/**
...
//# sourceMappingURL=lunr-standalone.js.map
